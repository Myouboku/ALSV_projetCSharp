/*
 ...
 ----------------------------------------------------------------------------
     ...
     Date de derni re modification : 24/3/2022 8:30:45
 ----------------------------------------------------------------------------
*/
...
create table COMPRENDRE
  (
     ...
     ,
     constraint PK_COMPRENDRE primary key (CON_ID, MED_ID)
  ) 
go
...
create table PROVOQUER
  (
     ...
     MED_ID smallint  not null  
     ,
     constraint PK_PROVOQUER primary key (EFF_ID, MED_ID)
  ) 
go
...
alter table COMPRENDRE 
     add constraint FK_COMPRENDRE_CONTRE_INDICATION foreign key (CON_ID) 
...
alter table COMPRENDRE 
     add constraint FK_COMPRENDRE_MEDICAMENT foreign key (MED_ID) 
...
alter table PROVOQUER 
     add constraint FK_PROVOQUER_EFFET_SECONDAIRE foreign key (EFF_ID) 
...
alter table PROVOQUER 
     add constraint FK_PROVOQUER_MEDICAMENT foreign key (MED_ID) 
               references MEDICAMENT (MED_ID)
go
...
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Doliprane', null, 1.07, 1000, 8, 1, 1, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Efferalgan', null, 2.10, 1000, 8, 2, 2, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Dafalgan', null, 1.16, 1000, 8, 2, 2, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Levothyrox', null, 10.28, 25, 30, 3, 2, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Imodium', null, 2.25, 2, 20, 3, 1, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Kardegic', null, 1.79, 500, 10, 3, 3, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Spasfon', null, 2.19, 2800, 10, 3, 4, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Ismig', null, 3.69, 2.5, 12, 3, 5, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Tahor', null, 15.76, 80, 90, 4, 5, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Spedifen', null, 4.90, 400, 12, 5, 5, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Voltarene', null, 2.36, 100, 10, 2, 4, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Eludril', null, 1.56, 500, 1, 6, 6, 2)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Ixprim', null, 3.04, 325, 20, 3, 5, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Paracetamol Biogaran', null, 1.07, 1000, 8, 7, 2, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Forlax', null, 3.90, 10000, 20, 3, 3, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Magne B6', null, 5.17, 48, 50, 1, 7, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Helicidine', null, 2.87, 10, 1, 8, 6, 2)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Clamoxyl', null, 1.87, 2000, 10, 9, 3, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Piascledine', null, 5.83, 300, 90, 10, 1, 1)
insert into MEDICAMENT(MED_NOM, MED_PHOTO, MED_PRIX, MED_QUANTITE, MED_NB_ENTITES, LAB_ID, ASP_ID, UNI_ID) values('Lamaline', null, 1.41, 340, 16, 11, 1, 1)
